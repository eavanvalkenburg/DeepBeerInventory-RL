...
game_arg.add_argument(
    "--maxEpisodesTrain", type=int, help="number of GAMES to be trained"
)
...
game_arg.add_argument(
    "--iftl", type=str2bool, default=False, help="if apply transfer learning"
)
game_arg.add_argument(
...
# DQN_arg.add_argument(
#     "--maxEpisodesTrain", type=int, default=60100, help="number of GAMES to be trained"
# )
# DQN_arg.add_argument("--NoHiLayer", type=int, default=3, help="number of hidden layers")
# DQN_arg.add_argument(
#     "--NoFixedLayer", type=int, default=1, help="number of hidden layers"
# )
# DQN_arg.add_argument(
#     "--node1",
#     type=int,
#     default=180,
#     help="the number of nodes in the first hidden layer",
# )
# DQN_arg.add_argument(
#     "--node2",
#     type=int,
#     default=130,
#     help="the number of nodes in the second hidden layer",
# )
# DQN_arg.add_argument(
#     "--node3",
#     type=int,
#     default=61,
#     help="the number of nodes in the third hidden layer",
# )
...
# DQN_arg.add_argument(
#     "--batchSize", type=int, default=64, help="the batch size which is used to obtain"
# )
# DQN_arg.add_argument(
#     "--minReplayMem",
#     type=int,
...
#     type=int,
#     default=1000000,
#     help="the maximum size of the replay memory",
# )
# DQN_arg.add_argument(
#     "--alpha",
#     type=float,
#     default=0.97,
#     help="learning rate for total reward distribution ",
# )
# DQN_arg.add_argument(
#     "--gamma", type=float, default=0.99, help="discount factor for Q-learning"
# )
# DQN_arg.add_argument(
#     "--saveInterval",
#     type=int,
...
# )
# DQN_arg.add_argument(
#     "--decayStep", type=int, default=10000, help="the decay step of the learning rate"
# )
# DQN_arg.add_argument(
#     "--decayRate",
#     type=float,
...
utility_arg.add_argument(
    "--number_cpu_active", type=int, default=5, help="number of cpu cores"
)
utility_arg.add_argument(
    "--gpu_memory_fraction",
    type=float,
...
test_arg.add_argument(
    "--testInterval", type=int, default=100, help='every xx games compute "test error"'
)
test_arg.add_argument(
    "--ifSaveFigure",
    type=str2bool,
...
test_arg.add_argument(
    "--f1", type=float, default=8, help="base stock policy decision of player 1"
)
test_arg.add_argument(
    "--f2", type=float, default=8, help="base stock policy decision of player 2"
)
test_arg.add_argument(
    "--f3", type=float, default=0, help="base stock policy decision of player 3"
)
test_arg.add_argument(
    "--f4", type=float, default=0, help="base stock policy decision of player 4"
)
test_arg.add_argument(
    "--f_init",
    type=list,
...
test_arg.add_argument(
    ...
    type=str2bool,
    default=False,
    help="If use f_init set it to True",
)
...
reporting_arg.add_argument(
    ...
    type=list,
    default=[],
    help="the result of dnn play tests will be saved here",
)
reporting_arg.add_argument(
    "--RsltRnd",
    type=list,
    default=[],
    help="the result of random play tests will be saved here",
)
reporting_arg.add_argument(
    "--RsltStrm",
    type=list,
    default=[],
    help="the result of heuristic fomula play tests will be saved here",
)
reporting_arg.add_argument(
    "--Rsltbs",
    type=list,
    default=[],
    help="the result of optimal play tests will be saved here",
)
reporting_arg.add_argument(
    "--ifSaveHist",
    type=str2bool,
...
def setAgentType(config):
    # if (
    #     config.gameConfig == 1
    # ):  # all agents are run by DNN- Also, load-model loads from brain-3+agentNum-
    ...
    # elif (
    #     config.gameConfig == 2
    # ):  # one agent is run by DNN- Also, load-model loads from brain-3+agentNum-
    #     # Also multi-agent with double target uses this gameConfig.
    #     config.agentTypes = ["srdqn", "srdqn", "srdqn", "srdqn"]
    #     config.to_prev_ai = [3, -1, -1, -1]
...
def fillnodes(config):
    if config.NoHiLayer == 2:
        config.nodes = [
            config.stateDim * config.multPerdInpt,
            config.node1,
            config.node2,
            config.actionListLen,
        ]
...
def setSavedDimentionPerBrain(config):
    if config.ifUsePreviousModel and not config.iftl:
        if (
            config.demandDistribution == 0
            and config.demandUp == 9
            and config.demandLow == 0
            and config.actionUp == 8
        ):
            ...
            config.demandDistribution == 1
            and config.demandMu == 10
            and config.demandSigma == 2
            and config.actionUp == 5
        ):
            if config.gameConfig == 3:
                config.multPerdInpt = 5
                config.NoHiLayer = 3
...
def update_config(config):
    ...
    if config.gameConfig == 0:
        ...
        setAgentType(
            config
        )  # set the agent brain types according to ifFourDNNtrain, ...
